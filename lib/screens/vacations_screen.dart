...
int userId;
  ...
  void getTenureDetails() async{
    var endPointUrl="https://www.futurechoiceclub.com/api/BookHoliday/GetAllTaner";
    ...
    http.Response response= await http.get(requestUrl);
        if(response.statusCode==200){
          ...
          if(responseData['Status']==1){
            ...
            Fluttertoast.showToast(msg: "NO data found", toastLength: Toast.LENGTH_SHORT,
  ...
  Widget build(BuildContext context) {
    ...
    appBar: AppBar(
      ...
      title: Text('My Vacations',style: TextStyle(
        color: Colors.white,
        fontSize: 16
      ),),
    ),
      body: vacationsData==null?Center(
        ...
        child: ListView.builder(
          ...
          return VacationListItem(index,getDate(vacationsData['DOjoining']),int.parse(vacationsData['Tenure']),
             vacationsData['Days'],vacationsData['Nights'] );
