...
class _ChangePasswordState extends State<ChangePassword> {
  ...
  void changePassword() async {
    http.Response response = await http.post('https://futurechoiceclub.com/api/passwordapi/ChangePassword',body: {
        "email":email,
    ...
    if(response.statusCode==200){
      ...
      if(responseBody['Status'] =="1"){
        ...
        Fluttertoast.showToast(msg: "Incorrect password provided", toastLength: Toast.LENGTH_SHORT,
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              ,
              TextFormField(controller: txtConfirmNewPassword,
